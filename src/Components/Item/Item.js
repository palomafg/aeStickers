...
const Item = ({ id, sticker, nombre, precio }) => {
    ...
    return (
        <div className={`${dark? 'dark' : 'light'} sticker col-5 col-lg-3 col-xxl-2 mx-sm-3 mx-xl-4 my-4 p-0 p-sm-3 row justify-content-center`}>
            ...
            <Link className="col-9 col-sm-6 col-md-5 col-lg-6 col-xl-5 col-xxl-8 my-2 my-md-3 my-xl-4 p-0 text-decoration-none" to={`/aeStickers/detalles/${id}`}>
