...
const Footer = () => {
    return (
        <div className="footer col-12 row p-0 pb-2 justify-content-center">
            <div className="col-12 col-lg-9 row m-0 p-0">
                <div className="col-5 col-xl-4 mt-5 ms-2 me-auto logoFooter">
                ...
                <div className="col-11 mt-4 mb-5 ms-auto me-2 creditos">
